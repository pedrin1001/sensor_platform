...
// if eeprom has been saved, this address should have the value 42 saved
#define EEPROM_CHECK 86
...
class SFE_BMP180
{
	...
	private:
		...
		EEPROMHelper eeprom;
		#ifdef WRITE_EEPROM
		int16_t AC1v,AC2v,AC3v,VB1v,VB2v,MBv,MCv,MDv;
		uint16_t AC4v,AC5v,AC6v;
		uint8_t AC1,AC2,AC3,VB1,VB2,MB,MC,MD;
		uint8_t AC4,AC5,AC6;
		#endif
		uint8_t c5,c6,mc,md,x0,x1,x2,y0,y1,y2,p0,p1,p2;
